...
package com.coder.dream.guice.lifecycle;
...
public class LifecycleServiceImpl implements LifecycleService {
    ...
    public void start() {
        ...
        log.info("Starting Guice lifecycle service...");
        ...
        log.info(String.format("Guice lifecycle service started in %d ms", time));
    ...
    public void stop() {
        ...
        log.info("Stopping Guice lifecycle service...");
        state = State.STOPPING;
        lifecycleRegister.stop();
        long time = System.currentTimeMillis() - start;
        log.info(String.format("Guice lifecycle service stopped in %d ms", time));
        state = lifecycleRegister.isStarted() ? State.STARTED : State.STOPPED;
    }
